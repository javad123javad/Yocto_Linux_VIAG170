...
SRC_URI = "git://git@github.com/bear24rw/alsa-utils.git;protocol=ssh"

# Modify these as desired
PV = "1.0.25+git${SRCPV}"
SRCREV = "2d105e0f18a82783ea69e2dbe9da7aeb7d3c1346"

S = "${WORKDIR}/git"

# NOTE: the following prog dependencies are unknown, ignoring: ncurses5-config xmlto ncursesw5-config
# NOTE: the following library dependencies are unknown, ignoring: menu$NCURSESLIBSUFFIX form$NCURSESLIBSUFFIX panel$NCURSESLIBSUFFIX curses
